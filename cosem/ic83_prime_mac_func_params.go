...
// PrimeMACFuncParams is the COSEM PrimeMACFuncParams interface class (IC 83).
type PrimeMACFuncParams struct {
...
func (s *PrimeMACFuncParams) ClassID() uint16               { return core.ClassIDPrimeMACFuncParams }
func (s *PrimeMACFuncParams) GetLogicalName() core.ObisCode { return s.LogicalName }
func (s *PrimeMACFuncParams) GetVersion() uint8             { return s.Version }

func (s *PrimeMACFuncParams) Access(attr int) core.CosemAttributeAccess {
	switch attr {
	case 1:
...
func (s *PrimeMACFuncParams) MarshalBinary() ([]byte, error) {
...
func (s *PrimeMACFuncParams) UnmarshalBinary(data []byte) error {
