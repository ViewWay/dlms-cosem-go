...
// SCHCLPWANDiagnostic is the COSEM SCHCLPWANDiagnostic interface class (IC 127).
type SCHCLPWANDiagnostic struct {
...
func (s *SCHCLPWANDiagnostic) ClassID() uint16               { return core.ClassIDSCHCLPWANDiagnostic }
func (s *SCHCLPWANDiagnostic) GetLogicalName() core.ObisCode { return s.LogicalName }
func (s *SCHCLPWANDiagnostic) GetVersion() uint8             { return s.Version }

func (s *SCHCLPWANDiagnostic) Access(attr int) core.CosemAttributeAccess {
	switch attr {
	case 1:
...
func (s *SCHCLPWANDiagnostic) MarshalBinary() ([]byte, error) {
...
func (s *SCHCLPWANDiagnostic) UnmarshalBinary(data []byte) error {
