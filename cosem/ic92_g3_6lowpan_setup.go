...
// G36LoWPANSetup is the COSEM G36LoWPANSetup interface class (IC 92).
type G36LoWPANSetup struct {
...
func (s *G36LoWPANSetup) ClassID() uint16               { return core.ClassIDG36LoWPANSetup }
func (s *G36LoWPANSetup) GetLogicalName() core.ObisCode { return s.LogicalName }
func (s *G36LoWPANSetup) GetVersion() uint8             { return s.Version }

func (s *G36LoWPANSetup) Access(attr int) core.CosemAttributeAccess {
	switch attr {
	case 1:
...
func (s *G36LoWPANSetup) MarshalBinary() ([]byte, error) {
...
func (s *G36LoWPANSetup) UnmarshalBinary(data []byte) error {
