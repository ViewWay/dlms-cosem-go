...
// G3HybridRFSetup is the COSEM G3HybridRFSetup interface class (IC 161).
type G3HybridRFSetup struct {
...
func (s *G3HybridRFSetup) ClassID() uint16               { return core.ClassIDG3HybridRFSetup }
func (s *G3HybridRFSetup) GetLogicalName() core.ObisCode { return s.LogicalName }
func (s *G3HybridRFSetup) GetVersion() uint8             { return s.Version }

func (s *G3HybridRFSetup) Access(attr int) core.CosemAttributeAccess {
	switch attr {
	case 1:
...
func (s *G3HybridRFSetup) MarshalBinary() ([]byte, error) {
...
func (s *G3HybridRFSetup) UnmarshalBinary(data []byte) error {
