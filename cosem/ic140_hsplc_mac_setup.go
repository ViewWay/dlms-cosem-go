...
// HSPLCMACSetup is the COSEM HSPLCMACSetup interface class (IC 140).
type HSPLCMACSetup struct {
...
func (s *HSPLCMACSetup) ClassID() uint16               { return core.ClassIDHSPLCMACSetup }
func (s *HSPLCMACSetup) GetLogicalName() core.ObisCode { return s.LogicalName }
func (s *HSPLCMACSetup) GetVersion() uint8             { return s.Version }

func (s *HSPLCMACSetup) Access(attr int) core.CosemAttributeAccess {
	switch attr {
	case 1:
...
func (s *HSPLCMACSetup) MarshalBinary() ([]byte, error) {
...
func (s *HSPLCMACSetup) UnmarshalBinary(data []byte) error {
